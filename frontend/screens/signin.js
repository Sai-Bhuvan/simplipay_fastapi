...
export default function SignIn({ onPageChange }) {
  ...
  return (
    <Layout style={global.screen}>
      <KeyboardAvoidingView style={{ flex: 1 }} keyboardVerticalOffset={600}>
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <Layout style={global.screen}>
            <Image
              source={require("../assets/logos/LogoTrans.png")}
              style={{
                width: 200,
                height: 200,
                marginTop: 0,
            ...
            >
              <Input
                ...
                label={
                  <Text style={[global.headerText, { fontFamily: "Main" }]}>
                    Phone no
                  </Text>
                }
                style={global.input}
              ...
              <Layout>
                ...
                <Button
                  onPress={() => onPageChange("SignUp")}
                  style={[
                    global.button,
                    { width: 120, marginBottom: 30, marginTop: 0 },
                  ]}
                >
                  <Text style={[global.touchableComp, { fontFamily: "Main" }]}>
                    Sign-up
